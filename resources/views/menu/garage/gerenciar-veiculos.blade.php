...
@section('title', 'GarageParts - Gerenciar Veículos')
...
@section('content_header')
    <h1>Garagem<small> Gerenciar Veículos</small></h1>
    <ol class="breadcrumb">
        <li class=""><i class="fa fa-home fa-lg" aria-hiden></i> Garagem</li>
        <li class="active"><i class="fa fa-flag-checkered fa-lg" aria-hiden></i> Gerenciar Veículos</li>
    </ol>
@stop
                ...
                <div class="box box-widget widget-user">
                    ...
                    <div class="box-footer">
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <a type="button" class="btn btn-primary btn-block" href="{{route('garage.gerenciar.veiculo.detalhes', $value->id)}}"><i class="fa fa-list-alt fa-lg" aria-hidden="true"></i> <strong>Detalhes do Veículo</strong></a>
                            </div>
