    ...
    @else
        ...
        @if(isset($servicos) && $servicos->count() == 0)
            <div class="box-background box-primary">
                <div class="box-body">
                    <div class="callout callout-info">
                        <h4>Nenhum Serviço foi encontrado!</h4>
                        <p>Adicione um novo serviço clicando no botão abaixo!</p>
                    </div>
                    <div>
                        <a type="button" class="btn btn-primary btn-flat" href="{{ route( 'service.cadastro.form' ) }}"><i class="fa fa-plus fa-lg" aria-hidden="true"></i> Cadastrar Novo Serviço</a>
                    </div>
                </div>
            </div>
        @else
