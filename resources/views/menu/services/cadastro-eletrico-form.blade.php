...
@section('title', 'GarageParts - Serviços Elétricos')
...
<h1>Cadastrar Serviços<small>Elétricos</small></h1>
    <ol class="breadcrumb">
        ...
        <li class="active"><i class="fa fa-bolt fa-lg" aria-hiden></i> Elétricos</li>
    </ol>
@stop
...
<div class="box-background box-primary">
        <div class="box-header with-border">
            <div class="form-group">
                <h3 class="box-title col-sm-10"><i class="fa fa-bolt" aria-hidden="true"></i> Adicionar Nova Manutenção Elétrica</h3>
            </div>
        </div>
            <form action="{{ route( 'service.cadastro.eletrico', $servico_id) }}" class="form-horizontal" method="POST">
            <div class="box-body">
                {!! csrf_field() !!} 
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <input class="form-control" value="{{old('quantidadeDePecas')}}" name="quantidadeDePecas" type="text" placeholder="Digite o nome do serviço" >
                    </div>
