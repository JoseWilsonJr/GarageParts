...
@section('content')
    ...
    <div class="row">
        @if(isset($abastecimentos) && $abastecimentos->count() == 0)
        <div class="col-md-9">
            <div class="box-background box-primary">
                <div class="box-body">
                    <div class="callout callout-info">
                        <h4>Nenhum registro encontrado para este filtro.</h4>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="box-body">
                    <div style="overflow-x:auto;">
                        ...
                        <form action="{{ route('abastecimento.gerenciar.historico.delete', $veiculo_id)}}">
                                @forelse($abastecimentos as $key => $abastecimento)
                                    <tr>
                                        <td class="tg-n62z"><input name="abastecimento_{{ $abastecimento->id }}" type="checkbox" value="{{ $abastecimento->id }}"></td>
