...
@section('content_header')
    <h1>Painel<small>Manutenções Hidraulicas</small></h1>
    <ol class="breadcrumb">
        ...
        <li class="active"><i class="fa fa-tint" aria-hidden="true"></i> Manutenções Hidraulicas</li>
    </ol>
@stop
    ...
    <div class="row">
        ...
        <div class="box-background box-info">
            <div class="box-header with-border">
                <h3 class="box-title"> <i class="fa fa-tint" aria-hidden="true"></i> Lista de Próximas Trocas</h3>
            </div>
            @if(isset($manut_hidraulicas) && $manut_hidraulicas->count()!=0)
                <div class="box-body">
                    <div style="overflow-x:auto;">
                        <table class="tg table">
                            <tbody>
                                ...
                                @forelse($manut_hidraulicas as $key => $mecanica)
                                <tr>
