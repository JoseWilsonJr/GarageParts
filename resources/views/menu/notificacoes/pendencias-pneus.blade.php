...
@section('content_header')
    <h1>Painel<small>Troca de Pneus</small></h1>
    <ol class="breadcrumb">
        ...
        <li class="active"><i class="fa fa-cog" aria-hidden="true"></i> Troca de Pneus</li>
    </ol>
@stop
    ...
    <div class="row">
        ...
        <div class="box-background box-info">
            <div class="box-header with-border">
                <h3 class="box-title"> <i class="fa fa-cog" aria-hidden="true"></i> Lista de Próximas Trocas</h3>
            </div>
            @if(isset($manut_pneus) && $manut_pneus->count()!=0)
                <div class="box-body">
                    <div style="overflow-x:auto;">
                        <table class="tg table">
                            <tbody>
                                ...
                                @forelse($manut_pneus as $key => $mecanica)
                                <tr>
